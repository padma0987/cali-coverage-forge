...
export function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <Link
      ...
      className="card-elegant group flex flex-col p-7 sm:p-8 servicebox"
    >
      {/*class for gold color icon: text-gold */}
      <Icon className="h-7 w-7 serviceicon" strokeWidth={1.4} aria-hidden="true" />
